...
bool ValidateQuarter(int Quarter)    // проверяем, является ли число четвертью
{
...
(int, int) FindCoords(int Quarter) // функция поиска шаблона координат (на выход можно вернуть две переменнных)
{
