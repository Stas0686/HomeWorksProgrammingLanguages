// Задача 1: Задайте двумерный массив размера m на n, каждый элемент в 
...
void Execute()
{
    int intM = PromptInt(strMessage: "Введите размерность M (строки): ");
    int intN = PromptInt(strMessage: "Введите размерность N (столбцы): ");
